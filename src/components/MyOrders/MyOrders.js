...
const MyOrders = () => {
    ...
    useEffect(() => {
        const url = `https://car-sales-server-website.vercel.app/myOrders/${user?.email}`;
    ...
    useEffect(() => {
        const url = `https://car-sales-server-website.vercel.app/cars`;
        fetch(url)
            .then(res => res.json())
            .then(data => {
                setCars(data);
    ...
    const handleCancelOrder = (id) => {
        ...
        if (proceed) {
            const url = `https://car-sales-server-website.vercel.app/deleteOrder/${id}`;
