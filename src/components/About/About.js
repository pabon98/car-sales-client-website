          ...
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body">
                Yes we offer our customers 10 year warrenty. We also give 5
                years warrenty for parts replacement. if you don't damage this
                surely you will get warrenty and garranty.
              </div>
            </div>
          </div>
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body">
                Yes, you will get discount all the time if you buy from us.we
                give our customer special discount always. and if you buy
                another car you will also get more discount.
              </div>
            </div>
          </div>
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body">
                We always keep brand new car in our warehouse. And We have also
                some old brand which are legend in speed. We sell for customer.
                So, We keep all the brands which customer prefer mostly.
              </div>
            </div>
          </div>
        </div>
